...
locales_dir = os.path.join(BASE_DIR, 'app/locale')
language = 'en'
gettext.bindtextdomain('messages', locales_dir)
gettext.textdomain('messages')
mo_file_path = os.path.join(locales_dir, language, 'LC_MESSAGES', 'messages.mo')
...
HTTP_200_OK = {
    200001: _("Import data successfully."),
}
HTTP_201_CREATED = {
}
HTTP_202_ACCEPTED = {
...
HTTP_401_UNAUTHORIZED = {
    401000: _("{}"),
    401001: _("Unknown or invalid token."),
    401002: _("You have already registered for this account, please try another account."),
    401003: _("Unknown or invalid token."),
    401007: _("Your account does not exist."),
    401009: _("Unknown or invalid refresh token."),
    401010: _("Your username or password incorrect")
}
